...
const TripReportPage = () => {
  ...
  const formatValue = (item, key) => {
    ...
    switch (key) {
      ...
      case 'fuelCost': {
        const fuelPrice = devices[item.deviceId]?.attributes?.fuelPriceMnt;
        return item.spentFuel > 0 && fuelPrice > 0
          ? formatCurrency(item.spentFuel * fuelPrice)
          : null;
      }
      case 'startAddress':
        return (
